...
object KeyCode {
    ...
    // AI Voice Typing: dedicated key code for the AI voice module, kept separate from
    // the platform VOICE_INPUT so both can coexist independently.
    const val AI_VOICE_INPUT =            -10055
    // Manual AI profile shortcuts are deliberately separate from automatic rotation.
