    ...
    SearchSettingsScreen(
        ...
        Scaffold(contentWindowInsets = WindowInsets.safeDrawing.only(WindowInsetsSides.Bottom)) { innerPadding ->
            Column(
                ...
                Preference(
                    name = stringResource(R.string.settings_screen_ai_voice_typing),
                    description = stringResource(R.string.ai_voice_typing_summary),
                    onClick = onClickAiVoiceTyping,
                    icon = R.drawable.ic_settings_ai_voice
                ) { NextScreenIcon() }
                Preference(
