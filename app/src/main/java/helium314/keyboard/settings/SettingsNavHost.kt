...
import helium314.keyboard.settings.screens.AiVoiceTypingScreen
import helium314.keyboard.settings.screens.AiVoiceProfilesScreen
    ...
    NavHost(
        ...
        composable(SettingsDestination.Settings) {
            MainSettingsScreen(
                ...
                onClickAiVoiceTyping = { navController.navigate(SettingsDestination.AiVoiceTyping) },
        ...
        composable(SettingsDestination.AiVoiceTyping) {
            AiVoiceTypingScreen(
                onClickBack = ::goBack,
                onOpenProfiles = { navController.navigate(SettingsDestination.AiVoiceProfiles) },
            )
        }
        composable(SettingsDestination.AiVoiceProfiles) {
            AiVoiceProfilesScreen(onClickBack = ::goBack)
        }
...
object SettingsDestination {
    ...
    const val AiVoiceTyping = "ai_voice_typing"
    const val AiVoiceProfiles = "ai_voice_profiles"
